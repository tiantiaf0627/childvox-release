...
class WhisperWrapper(
    ...
    def __init__(
        ...
        self.max_position = int(1500 // (30/self.max_audio_duration))
        ...
        if self.pretrain_model == "whisper_tiny":
            self.backbone_model = WhisperModel.from_pretrained(
                ...
                max_source_positions=self.max_position,
            )
    ...
    def forward(self, x, length=None, return_feature=False):
        ...
        if length is not None:
            max_audio_len = self.max_audio_duration*16000
        ...
        if length is not None:
            ...
            self.backbone_model.encoder.embed_positions = self.backbone_model.encoder.embed_positions.from_pretrained(self.embed_positions[:self.max_position])
        else:
            # Replace positional embeddings
    ...
    def _save_pretrained(self, save_directory: Path) -> None:
        state_dict = {
            ...
            if not k.startswith("backbone_model.") or "lora_" in k
        }
